        ...
        <div class="max-w-6xl mx-auto bg-white/90 backdrop-blur-md rounded-xl shadow-xl min-h-[600px] flex">
            ...
            <div class="w-80 border-r border-gray-200 bg-gray-50 p-4">
                <h2 class="text-xl font-bold text-gray-800 mb-4">
                    <i class="fas fa-headset mr-2"></i>Daftar Sales
                </h2>
                <div class="space-y-2">
                ...
                <?php if ($selectedSalesId): ?>
                    ...
                    <div class="flex-1 p-4 overflow-y-auto space-y-4" id="chat-box">
                        <?php foreach ($chatMessages as $msg): ?>
                            <div class="flex <?= $msg['senderId'] == $managerId ? 'justify-end' : 'justify-start' ?>">
                                <div class="max-w-[70%] <?= $msg['senderId'] == $managerId 
                                    ...
                                    <div class="text-xs mt-1 <?= $msg['senderId'] == $managerId 
                                        ? 'text-blue-100' 
                                        : 'text-gray-500' ?>">
